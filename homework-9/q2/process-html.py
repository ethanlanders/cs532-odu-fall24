...
if os.path.exists('homework-9/q2/processed_html'):
    print("processed_html directory exists. Deleting all files within it.\n")
    shutil.rmtree('homework-9/q2/processed_html')

os.makedirs('homework-9/q2/processed_html', exist_ok=True)
...
# Iterate through all files in the 'homework-9/q2/raw_html' directory
for filename in os.listdir('homework-9/q2/raw_html'):
    with open(f"homework-9/q2/raw_html/{filename}", 'r', encoding='utf-8') as file:
    ...
    try:
        ...
        if main_content.strip():
            with open(f"homework-9/q2/processed_html/{filename}", 'w', encoding='utf-8') as file:
