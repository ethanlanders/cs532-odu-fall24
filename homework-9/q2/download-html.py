...
# If the q2/raw_html directory already exists from a previous run,
# it deletes the folder and all its contents
if os.path.exists('homework-9/q2/raw_html'):
    print("q2/raw_html directory exists. Deleting all files within it.\n")
    shutil.rmtree('homework-9/q2/raw_html')

# Create a new q2/raw_html directory to store the downloaded HTML files
os.makedirs("homework-9/q2/raw_html")
...
for uri in uris:
    ...
    try:
        ...
        with open(f"homework-9/q2/raw_html/{filename}", 'w', encoding='utf-8') as file:
...
with open('homework-9/q2/uri_mapping.txt', 'w', encoding='utf-8') as f:
